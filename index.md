...
It starts with some exercises about Lie Groups (not very interesting) and then some thory about Coxeter Groups (seing their representation as matrices or diagrams). Also there are the decription of the Weil Groups, focusing on their visualization as symmetries of a roots system (sets of vectors with particular properties). In the end there is an example of application for classification of semisimple Lie groups.
